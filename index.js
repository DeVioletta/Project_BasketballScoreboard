...
documentgetElementById("add1PointsHome")
  .addEventListener("click", function () {
    countHome += 1;
    updateScore();
  });

document.getElementById("add2PointsHome")
  .addEventListener("click", function () {
    countHome += 2;
    updateScore();
  });

document.getElementById("add3PointsHome")
  .addEventListener("click", function () {
    countHome += 3;
    updateScore();
  });

document.getElementById("add1PointsGuest")
  .addEventListener("click", function () {
    countGuest += 1;
    updateScore();
  });

document.getElementById("add2PointsGuest")
  .addEventListener("click", function () {
    countGuest += 2;
    updateScore();
  });

document.getElementById("add3PointsGuest")
  .addEventListener("click", function () {
    countGuest += 3;
    updateScore();
  });
